...
export default function AdminLayout({
  ...
  const menuItems = [
    ...
    { name: "Student Approvals", href: "/admin/approvals", icon: UserCheck },
    { name: "MCQ Bank", href: "/admin/mcqs", icon: FileSpreadsheet },
    { name: "Test Builder", href: "/admin/tests", icon: BookOpen },
    { name: "Test Results", href: "/admin/results", icon: GraduationCap },
    { name: "Manage Content", href: "/admin/content", icon: Layers },
    ...
    <div className="min-h-screen bg-bg flex text-text">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-surface border-r border-border shrink-0">
        ...
        <div className="p-4 border-t border-border/50">
          <div className="flex items-center gap-3 px-3 py-2.5 mb-2 rounded-lg bg-red-500/5 text-xs text-text/60">
            <ShieldAlert className="w-4 h-4 text-red-500" />
            <div className="truncate">
              <p className="font-semibold text-text truncate uppercase">{session?.user?.role || "Staff"}</p>
      ...
      <div className="flex-grow flex flex-col min-w-0">
        ...
        <header className="h-16 bg-surface border-b border-border px-6 flex items-center justify-between z-30">
          ...
          <div className="flex items-center space-x-4">
            <ThemeToggle />
            <div className="w-8 h-8 rounded-full bg-red-500/10 text-red-500 flex items-center justify-center font-bold text-sm border border-red-500/20">
