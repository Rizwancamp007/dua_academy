...
import AdminMCQListView from "@/components/AdminMCQListView";
...
export default async function AdminMCQsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-serif text-3xl font-bold tracking-tight">MCQ Question Bank</h1>
        <p className="text-sm text-text/60 mt-1">
          Manage the central database of multi-choice questions. Filter by class and subject, add manually, or import from files.
        </p>
      </div>

      <AdminMCQListView classes={classes} streams={streams} subjects={subjects} />
    </div>
  );
}
